...
class Arm(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal[u"Arm",b"Arm",u"id",b"id",u"set",b"set"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"Arm",b"Arm",u"id",b"id",u"set",b"set"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal[u"Arm",b"Arm"]) -> typing_extensions.Literal["id","set"]: ...
global___Arm = Arm

...
class Arm(google.protobuf.message.Message):
    ...
    id: builtins.int = ...
    set: google.protobuf.internal.containers.RepeatedScalarFieldContainer[builtins.int] = ...

    def __init__(self,
        *,
        id : builtins.int = ...,
        set : typing.Optional[typing.Iterable[builtins.int]] = ...,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"id",b"id",u"set",b"set"]) -> None: ...
global___Arm = Arm
